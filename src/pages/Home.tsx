      ...
      {(!user) && (
        ...
        <section className="pt-4 pb-8">
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="flex items-center justify-between p-6 bg-blue-50 border border-blue-100 rounded-[32px] shadow-sm group transition-all active:scale-95"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h5 className="text-sm font-black text-blue-900 uppercase tracking-tight">Hotel di Mekah</h5>
                <p className="text-[10px] text-blue-600 font-bold uppercase tracking-widest mt-1 italic">Klik untuk lihat lokasi (Official)</p>
              </div>
            </div>
            <ExternalLink className="w-5 h-5 text-blue-400 group-hover:translate-x-1 transition-transform" />
          </a>
